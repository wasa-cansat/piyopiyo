...
//      digitalWrite(LEDR, LOW);
      ...
      if (abs(1.0 - accel) <= 0.1 && abs(accel - lastAccel) <= landedAccelThreshold && abs(pressure - lastPressure) <= landedPressureThreshold){
        i++;
        j=0;
