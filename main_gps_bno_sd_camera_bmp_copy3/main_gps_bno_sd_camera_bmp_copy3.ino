...
//35.707542,139.66114  35.707717,139.661239
//GPS関連
TinyGPSPlus gps;
double destLatitude = 35.70765559;    // 目的地の緯度
double destLongitude = 139.66126654;  // 目的地の経度
...
//      Serial.println(String(startTime / 1000) + "秒　　　");
      if(data.latitude != 0.0){
        ...
        Serial.println("m");
        if(count_gps % 15 == 0){
          data_gps[count_gps/15][0] = data.latitude;
          data_gps[count_gps/15][1] = data.longitude;
          data_gps[count_gps/15][2] = angle;
          data_gps[count_gps/15][3] = (double) millis();
        }
      ...
      while (1) {
        ...
        while(1){
          ...
          for(int i =0; i<80; i++){
            ...
            Serial.print(data_gps[i][0]);
            Serial.print("longitude: ");
            Serial.print(data_gps[i][1]);
            Serial.print("angle: ");
            Serial.print(data_gps[i][2]);
            Serial.print("time: ");
            Serial.print(data_gps[i][3]);
            delay(100);
          }
          delay(1000);
          Serial.println();
...
//      digitalWrite(LEDB, LOW);
      ...
      if (abs(accel - fallAccelThreshold) > 1.0) {
